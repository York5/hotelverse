  ...
  def do_init_db do
    data = [
      ...
      %{
        ...
        description: "From dazzling glacially fed lakes to high mountain plateaus to expansive grasslands, this camping retree will immerse visitors in the beauty and solitude of the remote Aysén region of Patagonia. The wild landscapes, adventurous trails, scenic transportation routes and unique local history are what makes this region so fascinating to explore.",
        detail_images: [
